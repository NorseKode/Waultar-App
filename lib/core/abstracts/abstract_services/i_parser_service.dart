...
abstract class IParserService {
  ...
  Future<void> parseIsolatesPara(String zipPath, Function(String message, bool isDone) callback, String serviceName, ProfileDocument profile, {int threadCount = 1});
