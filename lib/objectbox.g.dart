...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 7986903999584604040),
      name: 'FacebookPostModel',
      lastPropertyId: const IdUid(4, 3296098508908037990),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7278287785311826167),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 7391466522269391834),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 74664769778312515),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 3296098508908037990),
            name: 'timestamp',
            type: 10,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 2203205686300041010),
      name: 'AppSettingsBox',
      lastPropertyId: const IdUid(2, 5137348806379954565),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5298297933063149431),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5137348806379954565),
            name: 'darkmode',
            type: 1,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 2203205686300041010),
...
class FacebookPostModel_ {
  ...
  static final id =
      QueryIntegerProperty<FacebookPostModel>(_entities[0].properties[0]);

  /// see [FacebookPostModel.description]
  static final description =
      QueryStringProperty<FacebookPostModel>(_entities[0].properties[1]);

  /// see [FacebookPostModel.title]
  static final title =
      QueryStringProperty<FacebookPostModel>(_entities[0].properties[2]);

  /// see [FacebookPostModel.timestamp]
  static final timestamp =
      QueryIntegerProperty<FacebookPostModel>(_entities[0].properties[3]);
}
...
class AppSettingsBox_ {
  ...
  static final id =
      QueryIntegerProperty<AppSettingsBox>(_entities[1].properties[0]);

  /// see [AppSettingsBox.darkmode]
  static final darkmode =
      QueryBooleanProperty<AppSettingsBox>(_entities[1].properties[1]);
}
