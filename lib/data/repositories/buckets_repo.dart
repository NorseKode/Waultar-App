    ...
    _context.store.runInTransaction(TxMode.read, () {
      ...
      for (var year in years) {
        var model = YearModel(
          ...
          categoryCount: year.categoryMap.entries
    ...
    _context.store.runInTransaction(TxMode.read, () {
      ...
      for (var month in months) {
        var model = MonthModel(
          ...
          categoryCount: month.categoryMap.entries
              .map((e) => Tuple2(e.key, e.value))
              .toList(),
    ...
    _context.store.runInTransaction(TxMode.read, () {
      ...
      for (var day in days) {
        var model = DayModel(
          ...
          categoryCount: day.categoryMap.entries
              .map((e) => Tuple2(e.key, e.value))
              .toList(),
    ...
    _context.store.runInTransaction(TxMode.read, () {
      ...
      for (var hour in hours) {
        var model = HourModel(
          ...
          categoryCount: hour.categoryMap.entries
              .map((e) => Tuple2(e.key, e.value))
              .toList(),
      ...
      if (timestamps.isNotEmpty) {
        ...
        for (var timestamp in timestamps) {
          ...
          if (yearExists) {
            ...
            yearBucket.updateCounts(category, profileId);
            ...
            if (monthExists) {
              ...
              monthBucket.updateCounts(category, profileId);
              ...
              if (dayExists) {
                ...
                dayBucket.updateCounts(category, profileId);
                ...
                if (hourExists) {
                  ...
                  hourBucket.updateCounts(category, profileId);
                  ...
                  hourBucket.categoryMap = {category: 1};
                ...
                dayBucket.categoryMap = {category: 1};
              ...
              monthBucket.categoryMap = {category: 1};
            ...
            yearBucket.categoryMap = {category: 1};
